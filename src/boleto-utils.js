...
exports.identificarData = (codigo, tipoCodigo) => {
    ...
    if (tipoCodigo === 'CODIGO_DE_BARRAS') {
        if (tipoBoleto == 'BANCO') {
            ...
            ano = parseInt(codigo.substr(19, 4));
            console.log("ano: " + ano);
            mes = parseInt(codigo.substr(23, 2)) - 1;
            console.log("mes: " + mes);
            dia = parseInt(codigo.substr(25, 2))
            console.log("dia: " + dia);
        }
        ...
        if (tipoBoleto == 'BANCO') {
            ...
            ano = parseInt(cb.substr(19, 4))
            console.log("ano: " + ano);
            mes = parseInt(cb.substr(23, 2)) - 1;
            console.log("mes: " + mes);
            dia = parseInt(cb.substr(25, 2));
            console.log("dia: " + dia);
        }
    }
...
exports.validarCodigoComDV = (codigo) => {
    ...
    console.log('tipoCodigo ' + tipoCodigo);
    ...
    if (tipoCodigo === 'LINHA_DIGITAVEL') {
        ...
        if (tipoBoleto == 'BANCO') {
            ...
            console.log('identificacaoValorRealOuReferencia ', identificacaoValorRealOuReferencia);
            ...
            if (identificacaoValorRealOuReferencia.mod == 10) {
                ...
                bloco1 = codigo.substr(0, 11) + this.modulo11Arrecadacao(codigo.substr(0, 11));
                bloco2 = codigo.substr(12, 11) + this.modulo11Arrecadacao(codigo.substr(12, 11));
                bloco3 = codigo.substr(24, 11) + this.modulo11Arrecadacao(codigo.substr(24, 11));
                bloco4 = codigo.substr(36, 11) + this.modulo11Arrecadacao(codigo.substr(36, 11));
            }
...
exports.modulo11Arrecadacao = (bloco) => {
